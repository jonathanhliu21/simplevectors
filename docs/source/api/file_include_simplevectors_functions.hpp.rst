...
.. _file_include_simplevectors_functions.hpp:
...
Definition (``include/simplevectors/functions.hpp``)
----------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_include_simplevectors_functions.hpp.rst
...
Functions for the vector classes. This can be used for functional programming rather than using properties and methods of the classes.
...
- ``core/vector.hpp`` (:ref:`file_include_simplevectors_core_vector.hpp`)

- ``core/vector2d.hpp`` (:ref:`file_include_simplevectors_core_vector2d.hpp`)

- ``core/vector3d.hpp`` (:ref:`file_include_simplevectors_core_vector3d.hpp`)

- ``cstddef``

- ``initializer_list``

- ``vector`` (:ref:`file_include_simplevectors_embed.h`)
