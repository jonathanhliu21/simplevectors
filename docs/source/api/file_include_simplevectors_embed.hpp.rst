...
.. _file_include_simplevectors_embed.hpp:
...
Definition (``include/simplevectors/embed.hpp``)
------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_include_simplevectors_embed.hpp.rst
...
A minimized version of vectors for embedded devices with access to the STL. This file is meant to be a standalone file, so it is not included in :ref:`file_include_simplevectors_vectors.hpp`.
